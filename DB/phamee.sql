...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 19, 2022 at 01:27 PM
...
(4, 'ผ้าไมโครหรือผ้ากีฬา (ผ้าสี)', 1, 'ผ้าที่ผลิตจากเส้นด้ายโพลีเอสเตอร์(Polyester) ที่มีขนาดเล็กกว่า และ เพิ่มช่องว่างในเส้นใย ทำให้เนื้อสัมผัสเนียนนุ่มกว่า และด้วยเนื้อละเอียดนี่เองทำให้มันทนต่อการเปื้อน แห้งไวมาก', 150, 20, ''),
...
(6, 'ผ้าคอตตอนสแปนเด็กซ์(ผ้าสี)', 7, 'ผ้าทำจากใยยางสังเคราะห์ที่ มีคุณสมบัติคือ น้ำหนักเบา มีความยืดหยุ่นได้ดี เมื่อสวมใส่แล้วสามารถยืดขยายออกได้ดี และสามารถคืนตัวกลับมาในสภาพเดิม และสามารถระบายเหงื่อได้ดีอีกด้วย', 150, 64, ''),
...
(9, 'ผ้ายีนส์ (ยีนส์ไม่ยืด)', 6, 'ผ้าทอจากฝ้ายชนิดหนึ่ง แต่ไม่ได้อ่อนนุ่มเหมือนผ้าฝ้ายทั่วไป มีความแข็ง ความกระด้างมากกว่าผ้าฝ้ายที่ทอแบบอื่นๆ ผ้าเดนิมทั่วไป เราจะเห็นการทอจากด้ายอย่างน้อย 2 เส้น ทอขนานกันเป็นลายทาง', 150, 354, '');
...
--
ALTER TABLE `order`
  MODIFY `Or_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
